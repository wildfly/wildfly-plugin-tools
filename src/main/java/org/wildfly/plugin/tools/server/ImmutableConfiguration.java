...
class ImmutableConfiguration<T extends Configuration<T>> extends Configuration<T> {
    ...
    protected ImmutableConfiguration(final Configuration<T> configuration) {
        super(new ImmutableCommandBuilder(List.copyOf(configuration.commandBuilder()
                .buildArguments()), List.copyOf(configuration.commandBuilder().build())));
    ...
    private record ImmutableCommandBuilder(List<String> buildArguments, List<String> build) implements CommandBuilder {
    }
}
